...
<nav class="navbar navbar-expand-lg navbar-light" style = "background-color :#ABABAB;">
    <div class="container">
      <a href="${path}/MovieMain.jsp" class="navbar-brand">Movie Track</a>
        ...
        <div class="container">
          <form>
          <input type ="hidden" name = "RegType" value = "reg">
            <div class="form-group">
              <label for="InputEmail">이메일 주소</label>
              <div class="input-group">
              <input type="email" class="form-control" id="InputEmail" name ="id" placeholder="이메일 주소" readonly>
              <span class="input-group-btn">
                  <button class="btn btn-success" disabled>중복확인 완료<i class="fa fa-mail-forward spaceLeft"></i></button>
                </span>
            </div>
            </div>
            <div class="form-group">
              <label for="InputPassword1">비밀번호</label>
              <input type="password" class="form-control" id="InputPassword1" name ="pass" placeholder="비밀번호" required autofocus>
            </div>
            <div class="form-group">
              <label for="username">이름</label>
              <input type="text" class="form-control" id="username" name ="name" placeholder="이름을 입력해 주세요" required >
            </div>
            <div class="form-group">
              <label for="nickname">닉네임</label>
              <input type="text" class="form-control" id="nickname" name ="nickname" placeholder="닉네임을 입력해 주세요" required >
            </div>
            <div class="form-group">
              <label>성별</label><br>
                 <input type = "radio" id = "r1" name = "rr" value = "M" required >
		  			<label for = "r1"><span></span>남</label>&nbsp&nbsp&nbsp
		  		 <input type = "radio" id = "r2" name = "rr" value = "F" required > 
            ...
            <div class="form-group">
              <label for="phonenum">휴대폰 번호</label>
                <input type="tel" class="form-control" id="phonenum"  name ="phone" placeholder="- 포함해주세요" required>
            </div>
